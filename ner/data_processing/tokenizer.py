...
class Tokenizer(object):
    ...
    def tokenize(
        ...
        mask = [0 for i in output]
        id = []
        for word in output:
          id.append(self.token2id.get(word,self.token2id[self.unk_token]))
        ...
        return {"input_ids":torch.LongTensor(id),"padding_mask":torch.LongTensor(mask)}
